            ...
            <div className="w-11/12 grid grid-cols-4 mt-[31px] gap-6">
              <div className="bg-white shadow-[-5px_2px_14px] shadow-black/25 w-full rounded-[7px] h-[90px] px-[30px] py-[15px] flex items-center justify-between">
                ...
                <div className="flex-col flex">
                  ...
                  <h1 className="text-[19px] flex items-center font-medium text-[#202020]">{dataDashboard?.totalJamaah}</h1>
              ...
              <div className="bg-white shadow-[-5px_2px_14px] shadow-black/25 w-full rounded-[7px] h-[90px] px-[30px] py-[15px] flex items-center justify-between">
                ...
                <div className="flex-col flex">
                  ...
                  <h1 className="text-[19px] flex items-center font-medium text-[#202020]">{dataDashboard?.totalMitra}</h1>
              ...
              <div className="bg-white shadow-[-5px_2px_14px] shadow-black/25 w-full rounded-[7px] h-[90px] px-[30px] py-[15px] flex items-center justify-between">
                ...
                <div className="flex-col flex">
                  ...
                  <h1 className="text-[19px] flex items-center font-medium text-[#202020]">{dataDashboard?.totalPackageUmrohActive}</h1>
              ...
              <div className="bg-white shadow-[-5px_2px_14px] shadow-black/25 w-full rounded-[7px] h-[90px] px-[30px] py-[15px] flex items-center justify-between">
                ...
                <div className="flex-col flex">
                  ...
                  <h1 className="text-[19px] flex items-center font-medium text-[#202020]">{dataDashboard?.totalOrder}</h1>
