...
const dummyPackages = [
  {
    id: 1,
    mitra: "Hasanah Hana",
    namaPaket: "Umroh Paket Plus Amanah",
    kategori: "Paket Plus",
    harga: "Rp32.000.000",
    kuota: "0/150",
    berangkat: "Senin 23/10/2025",
    pulang: "Selasa 3/10/2025",
  },
  {
    id: 2,
    mitra: "Hasanah Hana",
            ...
            <div className="mt-[20px] w-11/12 mx-auto">
              ...
              <div className="flex items-center w-7/12 justify-between mt-[34px]">
                ...
                <div className="flex   gap-6 text-[#001F5D] font-medium text-sm">
                  <span className="border-b-4 border-[#001F5D] font-bold">Baru</span>
                  <span>Di tolak</span>
                  <span>Di terima</span>
                </div>
              </div>
                ...
                <div className="col-span-11 flex flex-row gap-4">
                  ...
                  <div className="flex flex-col font-medium justify-evenly items-start text-sm">
                    <div className="">
                      ...
                      <h2 className=" font-medium">{pckg.mitra}</h2>
                    </div>
                    <div className="">
                      <p className=" font-medium">{pckg.namaPaket}</p>
                      <p className="text-xs font-medium">{pckg.kategori}</p>
                    </div>
                  </div>

                  <div className="flex flex-col justify-evenly text-sm">
                    <p className="font-bold">{pckg.harga}</p>
                    <div className="flex flex-col justify-center text-sm">
                      <p>Tanggal keberangkatan</p>
                      <p className="font-semibold">{pckg.berangkat}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col justify-evenly">
                    ...
                    <div className="flex flex-col justify-center text-sm">
                      ...
                      <p className="font-semibold">{pckg.pulang}</p>
                    </div>
                  </div>
