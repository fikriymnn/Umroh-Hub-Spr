            ...
            <div className="w-11/12 mx-auto">
                <div className="w-full flex justify-between mb-6">
                    <div className="flex flex-col md:flex-row items-start md:items-center gap-10 ">
                        ...
                        <h1 className="text-[20px] font-bold text-[#1B50BA]">Ahmad Danur wiarsa <span></span></h1>
                        <p className=" text-[#3C97FF] flex items-center space-x-2 text-[14px] font-medium">Jemaah
                        <span className="text-[10px] ms-[22px] text-[#9A9A9A] font-medium">Mendaftar sejak 25-07-2023</span></p>
                ...
                <div className="mt-6 rounded-[19px] shadow-black/25 shadow-[0px_4px_11.4px] p-[26px]">
                    ...
                    <h3 className='text-[12px]'><span className=" text-[12px] font-medium text-[#797979]">Nama</span> : Ahmad Danur Wiarsa</h3>
                    <h3 className='text-[12px]'><span className=" text-[12px] font-medium text-[#797979]">Jenis Kelamin</span> : Laki-laki/Ikhwan</h3>
                    <h3 className='text-[12px]'><span className=" text-[12px] font-medium text-[#797979]">Alamat</span> : Jl karya bakti kencana indah parahyangan rt 4 rw 3</h3>
                    <h3 className='text-[12px]'><span className=" text-[12px] font-medium text-[#797979]">Email</span> : Danuri@gmail.com</h3>
                    <h3 className='text-[12px]'><span className=" text-[12px] font-medium text-[#797979]">No Telp</span> : 08780099854</h3>
